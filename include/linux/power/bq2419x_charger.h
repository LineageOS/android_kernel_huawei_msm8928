...
#define BQ2419x_OTG_TIMEOUT    (10000)
#define MAX_ALLOWED_CURRENT    (-3600)
...
#define BQ2419x_COLD_BATTERY_THRESHOLD     (-10)
 /*(3 ) battery temperature is 3 degree*/
#define BQ2419x_COOL_BATTERY_THRESHOLD      (3)
...
/* for running test, force IC to discharge */
